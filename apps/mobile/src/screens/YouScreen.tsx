...
function AuthSheet({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Sheet onClose={onClose}>
      ...
      <Text style={{ fontFamily: FONTS.display, fontSize: 60, lineHeight: 70, color: t.colors.text.primary, marginBottom: 18, marginLeft: -9, paddingLeft: 9 }}>
    ...
    <View style={{ flex: 1, backgroundColor: t.colors.bg.screen }}>
      <ScrollView contentContainerStyle={{ paddingHorizontal: 22, paddingBottom: 48 }}>
        ...
        <View style={{ paddingTop: 10, marginBottom: 26 }}>
          ...
          <Text style={{ fontFamily: FONTS.display, fontSize: 64, lineHeight: 74, color: t.colors.text.primary, marginLeft: -10, paddingLeft: 10 }}>
