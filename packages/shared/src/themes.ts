...
export const THEMES: Record<ThemeName, Theme> = {
  'warm-start': {
    ...
    colors: {
      ...
      wheel:      WHEEL_WARM,
      wheelLight: ['#F9E8DC','#F7DDD8','#DCF0EE','#FAF0DC','#EEEDF5','#F5E8F2','#E8F4E2','#FAEEE8'],
    },
  },
  ...
  'slow-down': {
    ...
    colors: {
      ...
      wheel:      WHEEL_SLOW,
      wheelLight: ['#3A2E28','#382420','#1E3432','#3A3220','#2C2A38','#302430','#2A3828','#382C28'],
    },
  },
  ...
  'light-a11y': {
    ...
    colors: {
      ...
      wheel:      WHEEL_LIGHT_A,
      wheelLight: ['#F9EEE8','#F7E4E0','#E0F2F0','#F5EDD0','#ECEAF7','#F5E4F0','#E4F2E0','#F2E0EA'],
    },
  },
  ...
  'dark-a11y': {
    ...
    colors: {
      ...
      wheel:      WHEEL_DARK_A,
      wheelLight: ['#3A2820','#382020','#183430','#382E10','#282438','#301820','#183A28','#3A1A20'],
    },
  },
};
